...
export default function Header() {
    return (
        <div classNameName="headerDivStyle">
            <nav className="navbar navbar-expand-lg navbar-light text-white navStyle">
                <a className="navbar-brand" href="#">Online Storer</a>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div className="wishList px-2">
                        Wishlist
                            ...
                            <Badge color="secondary" badgeContent={22}>
                                <FavoriteBorderIcon badge className="header__icon" fontSize="small" />
                            </Badge>
                        </IconButton>
                    </div>
                    <div className="cartList px-2">
                        Cart
                            <IconButton>
                            <Badge color="secondary" badgeContent={66}>
